...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "Si {first} Suka peju",
    "Si {first} Suka peju",
    "{first} Jualan batagor",
    "{first} Jualan batagor",
    "{first} Jualan batagor",
    "{first} Jualan somay.",
    "{first} Jualan somay",
    "{first} Jualan somay.",
    "Hahah {first} Suka makan jembutnya",
    "Hahah {first} Suka makan jembutnya",
    "Hahah {first} Suka makan jembutnya",
    "Disini tempat prik mending pergi gih {first}!",
    "{first} Disini tempat prik mending pergi gih",
    "{first} Disini tempat prik mending pergi gih",
    "{first} Pengedar Narkoba.",
    "{first} Pengedar Narkoba.",
    "{first} Pengedar Narkoba.",
    "{first} Pengedsr Narkoba.",
    "{first} Pengedar Narkoba.",
    "{first} Run ada wibuuu bau bawangggg",
    "{first} Run ada wibuuu bau bawangggg",
    "{first} Run ada wibuuu bau bawangggg",
    "{first} Run ada wibuuu bau bawangggg",  # Discord welcome messages end.
    "Haii koncoll {first}",
    "Haii koncoll {first}",
    "Haii koncoll{first}",
    "ish bau bat",  # Tekken
    ...
    "{first} Bau bngt anj minimal mandi kek",
    "{first} Bau bngt anj minimal mandi kek",
    "{first} Bau bngt anj minimal mandi kek",  # Hunter Hunter
