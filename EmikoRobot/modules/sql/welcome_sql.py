...
DEFAULT_WELCOME_MESSAGES = [
    "{first} Wlkom nak kntoool!",  # Discord welcome messages copied
    "Ehh si jamettt {first}",
    "Welkm beban keluarga {first} .",
    "{first} Si paling alayyy.",
    "{first} Sedang mengocok",
    "{first} Klo udh join jangan keluar ya NGENTOOOD.",
    "{first} Intro nya kaka",
    "{first} Awasss ada malinggg",
    "{first} Klo udh masuk nimbrung ya koncoll",
    "Welcome, {first}. Oni gank opmem kaa",
    "Welcome, {first}. Oni gank op ga ada obat",
    "Welcome, {first}. Semoga ga betah xixi",
    "Welcome, {first}. Jangan lupa napass",
    "{first} Suka ngocok.",
    "{first} Suka bnget sama pake lipstik.",
    "{first} Suka ciumin ketek.",
    "{first} Suka jilat kaki sendiri.",
    "{first} Suka makan upil.",
    "{first} hei apakah kamu beban keluarga?.",
    "Si {first} Suka peju",
    "Si {first} Suka sama cimoy",
    "{first} Pengen di belaiii bangg",
    "{first} Aduhhh si buntung ngapainn",
    "{first} Sok ngartis klo di pc",
    "{first} Kalo coli pake bon cabe biar ada rasa pedas nya katanya.",
    "{first} Kalo jalan suka pake kaki",
    "{first} Suka banget klo makan sambil berak.",
    "Hahah {first} Kalo kesini cmn jadu badut",
    "Hahah {first} Napas nya bau jigong",
    "Hahah {first} Kalo kentut suaranya kecil tpi bau nya ngena bangettt",
    "Disini tempat prik mending pergi gih {first}!",
    "{first} Kiw moga dpt jandaaa",
    "{first} Cih pengecut luu",
    "{first} Kalo ribut suka bawa kawan.",
    "{first} Pengedar Narkoba.",
    "{first} Run ada wibuu bau bawanggg.",
    "{first} Suka duel sama bapak sendiri.",
    "{first} Si tukang nyuri korek.",
    "{first} Suka ngewe in kucing",
    "{first} Suka ngewe in ayam",
    "{first} Suka ngewe in kambingg",
    "{first} .",  # Discord welcome messages end.
    "Haii koncoll {first}",
    "Haii anak dajjal {first}",
    "Haii Bocah biadab yg suka ngelawan ortu {first}",
    "ish bau bat {first}",  # Tekken
    "bauu {first}",
    "{first} Bau bngt anj minimal mandi kek",
    "{first} Bau bngt anj minimal mati kek",
    "{first} Bau bngt anj minimal coli kek",
    "{first} Bau bngt anj minimal ngewe kek",  # Hunter Hunter
    "Liat dah anak hasil peju buangan gini nih {first}.",  # One Punch man s2
    "Liat dah anak hasil peju buangan gini nih {first}",
    "Liat dah anak hasil peju buangan gini nih {first}.",
    "disini gausa sok belaga jdi jagoan ya nyet {first} ",  # One Punch ma
    "disini gausa sok belaga jdi jagoan ya nyet {first}.",  # One Punch ma
    "Hey, {first}, apakah kamu seorang penjilat?",  # One Punch ma
    "Hey, {first}, apakah kamu seorang penjilat?",
    "Hey, {first}, apakah kamu seorang pecundang?",
    "{first} Si paling jelek",
    "{first} Si paling so asik",
    "{first} Si paling bacoddddd",
    "{first} Si paling kontolllll",
